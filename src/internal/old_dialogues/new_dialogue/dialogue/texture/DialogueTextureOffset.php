...
final class DialogueTextureOffset implements JsonSerializable{
	...
	public static function defaultPlayerPortrait() : self{
		 ...
		 * This only need when you want to spawn Human . (the  goes off when you open dialogue)
		 * @author Tobias Grether ({@link https://github.com/TobiasGrether})
		 * {@link https://github.com/refteams/libDialogue/commit/521bf630a1e4efc70f8c410a0f51f61950381e62}
		 */
