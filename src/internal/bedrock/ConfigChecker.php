...
use internal\bedrock\exception\libBedrockUnexpectedValueException;
...
class ConfigChecker {
	...
	public static function checkConfigVersion(PluginBase $plugin, Config $config, string $configKey, string $latestVersion, string $updateMessage = "") : bool {
		...
		if (!is_string($configKey)) {
			throw new libBedrockUnexpectedValueException('Parameter #3 $configKey of method internal\bedrock\ConfigChecker::checkConfigVersion() expects string, mixed given.');
		}
