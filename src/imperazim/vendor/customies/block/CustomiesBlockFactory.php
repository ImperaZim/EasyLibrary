...
namespace imperazim\vendor\customies\block;

use Closure;
use imperazim\vendor\customies\block\permutations\Permutable;
use imperazim\vendor\customies\block\permutations\Permutation;
use imperazim\vendor\customies\block\permutations\Permutations;
use imperazim\vendor\customies\item\CreativeInventoryInfo;
use imperazim\vendor\customies\item\CustomiesItemFactory;
use imperazim\vendor\customies\task\AsyncRegisterBlocksTask;
...
final class CustomiesBlockFactory {
  ...
  */
  public function registerBlock(string $className, string $identifier, ?Model $model = null, ?CreativeInventoryInfo $creativeInfo = null, ?Closure $serializer = null, ?Closure $deserializer = null): void {
    ...
    $this->blockFuncs[$identifier] = [$className,
      $serializer,
      $deserializer];
