...
class ToggleableEffectEnchant extends ToggleableEnchantment {
  ...
  public function __construct(int $id, string $name, int $maxLevel, int $usageType, int $itemType, private Effect $effect, private int $baseAmplifier = 0, private int $amplifierMultiplier = 1, int $rarity = Rarity::RARE) {
    $this->name = $name;
    $this->rarity = $rarity;
  ...
  public function getDefaultExtraData(): array {
    return ["baseAmplifier" => $this->baseAmplifier,
